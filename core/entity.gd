...
# Register a group with its required components
# func register_group_components(group_name: String, component_types: Array):
# 	_group_components[group_name] = component_types
# 	# Check if entity already has all required components
...
func _set(property, value):
	...
	if property.begins_with("c_"):
		...
		var comp = findComp(comp_property)
		if comp:
